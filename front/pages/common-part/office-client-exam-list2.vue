<template>
  <div class="offfice">
    ...
    <el-form :inline="true" class="demo-form-inline" :loading="loading" size="mini">
      ...
      <el-form-item>
        <el-button-group>
          ...
          <el-button  @click="add_form.visible=true" :disabled="disabled">增加新考点</el-button>
    ...
    >
      ...
      <el-table-column label="这次考试的总监考费">
        <template scope="scope">
          {{exam_item.total}}
        </template>
      </el-table-column>
      <el-table-column prop="total"  label="该学校的总考费"></el-table-column>

      <el-table-column   label="考试状态" width="80">
        <template scope="scope">
      ...
      <el-table-column  label="操作"  width="235">
        <template scope="scope">
          <el-button-group>
            ...
            <el-button @click="$router.push('/schoolexam2?id='+scope.row.id)" size="mini">分配监考老师</el-button>
          </el-button-group>
