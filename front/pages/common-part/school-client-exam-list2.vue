<template>
  <div class="exam-teacher">
    ...
    <el-form :inline="true" class="demo-form-inline" :loading="loading" size="small">
      ...
      <el-form-item>
        <el-button-group>
          <el-button  @click="add_form.visible=true" size="small" :disabled="disabled || loading">增加监考老师</el-button>
      ...
      <el-table-column  label="序号">
        ...
        <el-table-column prop="exam_total" label="考试办总监考费"></el-table-column>

        <el-table-column prop="school_exam_total" label="本校总监考费"></el-table-column>
