  ...
  <div class="exam">
    ...
    <!--</el-form>-->
      ...
      <el-table-column   label="锁表" width="100">
        ...
        <el-table-column prop="total" label="本校总监考费"></el-table-column>
        ...
        <el-table-column  label="操作" width="135" >
          <template scope="scope">
            <el-button-group>
              <el-button type="primary" @click="$router.push('/schoolexam2?id='+scope.row.id)" size="mini">分配监考老师</el-button>
